...
function generateChannelArtifacts() {
	...
	echo "#################################################################"
	$CONFIGTXGEN -profile OrgsChannel -outputAnchorPeersUpdate ./channel-artifacts/AssetManagerOrgMSPanchors.tx -channelID $CHANNEL_NAME -asOrg AssetManagerOrgMSP
	echo
}
